...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctxAdmin}/cms/site/">站点列表</a></li>
		<li class="active"><a href="${ctxAdmin}/cms/site/form?id=${site.id}">站点<e:hasPermission name="cms:site:edit">${not empty site.id?'修改':'添加'}</e:hasPermission><e:lacksPermission name="cms:site:edit">查看</e:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="site" action="${ctxAdmin}/cms/site/_save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:input path="code" htmlEscape="false" maxlength="36" class="input-xlarge required"/>
                <span class="help-inline">主站编码为“1”</span>
            </div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="theme">
					<form:options items="${fns:getDictList('cms_theme')}" itemLabel="name" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<e:hasPermission name="cms:site:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</e:hasPermission>
