...
<link href="${ctxStatic}/js/common/jeesite.min.css" type="text/css" rel="stylesheet" />
<link href="${ctxStaticTheme}/style.min.css" type="text/css" rel="stylesheet" />

<%--自定义的css文件   2014年11月李绎如--%>
<link href="${ctxStatic}/img/jfit_css/blue.css" type="text/css" rel="stylesheet" />
<%--兼容区--%>
<!--[if IE 7]>
