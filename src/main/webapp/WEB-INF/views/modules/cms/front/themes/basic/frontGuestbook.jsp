	...
	<div style="padding:0 0 20px;">
		...
		<ul>
			<c:forEach items="${page.result}" var="guestbook">
				<li>
					<h5>姓名: ${guestbook.name} &nbsp;时间：<fmt:formatDate value="${guestbook.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/></h5>
		...
		<form:form id="inputForm" action="" method="post" class="form-horizontal">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="email" maxlength="50" class="email" style="width:300px;"/>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">电话:</label>
				<div class="controls">
					<input type="text" name="phone" maxlength="50" class="phone" style="width:300px;"/>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">单位:</label>
				<div class="controls">
					<input type="text" name="workunit" maxlength="50" class="" style="width:300px;"/>
				</div>
			</div>
			<div class="control-group">
