...
<div class="container backgroundcontainer">
  ...
  <div class="container">
	...
	<div class="span10" style="padding-top:15px;margin-left:4px;" id="frontViewArticle_show_span10_height">
	     <div class="row" style="margin-left:6px;">
            ...
            <%--  <div style="border-top:1px solid #ddd;padding:10px;margin:25px 0;">发布时间：<fmt:formatDate value="${article.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/> &nbsp;点击数：${article.hits}</div> --%>
  	     </div>
	    <%--  <div class="row" style="margin-left:6px;">
 ...
 <script type="text/javascript">
	$(document).ready(function(){
		$(".tanhuang_center").height($("#frontViewArticle_show_span10_height").height()+65);
	});
</script>
</body>
</html>