	...
	<div class="container">
		<div class="row-flow">
			...
			<div class="span6 pull-right" >
				...
				<img class="pull-right" id="bg_music_img" alt="背景音乐控制" style="margin:29px 0 20px;" title="" src="${ctxStatic}/img/jfit/on.png" onclick="toggle()">
...
<div class="navbar navbar-fixed-top" style="position:static;margin-bottom:0;">
	<div class="navbar-inner" style="background-color:transparent;background-image:url(${ctxStatic}/img/jfit/nav_background.png);background-repeat:repeat-x;border:none;">
		<div class="container">
...
<!-- </div> --> <!-- /container -->
<div id="jplayer"></div>
<script src="${ctxStatic}/js/jquery/jplayer/jquery.jplayer.min.js" type="text/javascript"></script>
<script type="text/javascript">
	var music_on=false;
	var musics=new Array();
	musics[0]="${ctxStatic}/img/media/tip_new_msg.mp3";
	var index;
	var $jplayer;
	$(document).ready(function(){
		//背景音乐
	...
	function toggle(){
		if(music_on){//开启
			$("#bg_music_img").attr({ src: "${ctxStatic}/img/jfit/on.png", title: "关闭背景音乐" });
			//背景音乐
			index=Math.round(Math.random()* (musics.length -1));
			$jplayer.jPlayer("setMedia", {
				mp3:musics[index]
			}).jPlayer('play');
			music_on=false;
		}else{//停止
			$("#bg_music_img").attr({ src: "${ctxStatic}/img/jfit/off.png", title: "开启背景音乐" });
