...
public class Category extends TreeEntity<Category> {
	...
	private String organId;	// 归属部门
	private String organName;	// 归属部门
...
//	private Integer sort; 		// 排序（升序）
	...
	private String deviceConfig;//显示设备参数，多选（1：PC端是否显示；2：移动端是否显示；）
...
//	}
	...
	public List<String> getDeviceconfigList() {
		List<String> list = Lists.newArrayList();
		if (deviceConfig != null){
			for (String s : StringUtils.split(deviceConfig, ",")) {
				list.add(s);
			}
		}
		return list;
	...
	public void setDeviceconfigList(List<String> list) {
		deviceConfig = ","+ StringUtils.join(list, ",")+",";
	}
