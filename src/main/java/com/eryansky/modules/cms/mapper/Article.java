...
public class Article extends DataEntity<Article> {
	...
	private String posid;	// 推荐位，多选（1：首页焦点图；2：栏目页文章推荐；3：首页推荐）
	...
	public Article setArticleData(ArticleData articleData) {
	...
	public String getThumbSrc() {
		return CmsUtils.formatImageSrcToWeb(this.thumb);
	}

	public String getCreateUserName(){
		return UserUtils.getUserName(createUser);
	}

	public String getUpdateUserName(){
		return UserUtils.getUserName(updateUser);
	}
