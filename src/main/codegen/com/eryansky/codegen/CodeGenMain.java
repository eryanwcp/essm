...
//        DbConfig dbConfig = new DbConfig(DRIVER,URL,USERNAME,PASSWORD);
        DbConfig dbConfig = new DbConfig(AppConstants.getJdbcDriverClassName(), AppConstants.getJdbcUrl(),AppConstants.getJdbcUserName(),AppConstants.getJdbcPassword());
        List<Table> tables = null;
        Builder builder = null;
        DataSource db = null;
        String t = "t_party%";//表 通配"%"
        Table table = null;
        try {
